...
export default function MemberView() {
  ...
  useEffect(() => {
    const readData = async () => {
      try {
        const response = await axios.get('https://dolbosigae.site/member/list');
  ...
  const handlePageChange = (pageNo) => {
    const fetchPageData = async () => {
      try {
        const response = await axios.get(`https://dolbosigae.site/member/list?page=${pageNo}`);
        setMemberList(response.data.members);
        setPagination(response.data.pagination);
      } catch (error) {
  ...
  const deleteClick = async (memberId) => {
    try {
      const response = await axios.delete(`https://dolbosigae.site/member/delete/${memberId}`);
  ...
  const updateClick = async (member) => {
    try {
      const response = await axios.post(`https://dolbosigae.site/member/update`, member);
